...
Оформление ответа для Telegram (только поддерживаемая разметка):
- Разрешено: **жирный**, *курсив*, инлайн-код \`...\`, блоки кода \`\`\`js ... \`\`\`, ссылки [текст](url), нумерованные (1. 2.) и маркированные (- или •) списки.
- Подзаголовки разделов — **жирным** на отдельной строке; сравнения и параметры — списком, не таблицей.
- Запрещено: таблицы (| col |), заголовки с #, горизонтальные линии (---), изображения ![...](...), сноски [^1].
