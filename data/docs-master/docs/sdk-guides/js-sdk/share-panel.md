...
To customize the  `SharePanel` you need use the `storyReaderOptions.sharePanel` prop to pass the `SharePanel` configuration.
...
- **Title Configuration**: Provides default settings for the panel's title, including the display of the favicon.
