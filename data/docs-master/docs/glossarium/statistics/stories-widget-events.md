...
- [iOS](/sdk-guides/ios/events#events-triggered-after-interacting-with-stories): use the `IASEvent.Story.storyWidgetEvent()`
- [Android](/sdk-guides/android/events#notifications-from-widgets-in-stories-reader): `InAppStoryManager.getInstance().setStoryWidgetCallback()`
- [JS](/sdk-guides/js-sdk/events#widgetevent): `inAppStoryManager.on("widgetEvent", (payload) => {})`;
...
Click on offer card in a product carousel
